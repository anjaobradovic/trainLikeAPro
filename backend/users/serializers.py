...
class RegisterTrainerSerializer(serializers.ModelSerializer):
    ...
    gender = serializers.ChoiceField(write_only=True, choices=TrainerProfile.Gender.choices)

    class Meta:
        model = User
        fields = ['username', 'email', 'first_name', 'last_name', 'password', 'password2',
                  'license_number', 'specialty', 'biography', 'date_of_birth', 'gender']
...
class AdminUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'role', 'is_active', 'is_deleted', 'date_joined', 'last_login',
        ]
